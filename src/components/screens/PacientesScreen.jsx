...
export const PacientesScreen = () => {
    ...
    const { contextoToast, toastAbierto, modalAbierto } = useSelector(state => state.ui)
    ...
    return (
        <>
            {toastAbierto && !modalAbierto && <Toast exitoso={contextoToast.exito} mensaje={contextoToast.mensaje} />}
